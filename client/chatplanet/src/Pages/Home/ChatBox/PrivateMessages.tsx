        ...
        <div className=''>
         ...
         {messages && (<div className='space-y-2 pb-16'>
           ...
           {allusers  && (    <div key={index}   className={`mb- p-2 w-full    rounded-lg ${
              msg.sender_id === authUser?.id ? "bg-violet-200 dark:bg-violet-100 text-slate-700 dark:text-slate-700 border-1 font-medium    " : "bg-violet-600 dark:bg-violet-600 text-white font-medium dark:text-white  "
            }`}>{
