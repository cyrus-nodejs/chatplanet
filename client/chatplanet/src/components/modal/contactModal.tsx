...
const ContactModal = () => {
  ...
  return (
    ...
    <input   value={formik.values.email} onChange={formik.handleChange}  name="email"   type="email" placeholder="Email"   className="input grow input focus:outline-none h-10  bg-white w-5/6"  id="leadingIconDefault" />
  </div>
    ...
    <input   value={formik.values.invitation}  onChange={formik.handleChange}  name="invitation"      placeholder="Enter Message"   className="input input focus:outline-none  h-24  bg-white  grow w-5/6"  id="leadingIconDefault" />
  </div>
        ...
        {formik.touched.invitation && formik.errors.invitation && (
          ...
          <button type="submit" disabled={submitting}   className="bg-violet-500 text-white h-10 p-2 rounded-md hover:bg-blue-600"   >  Invite Contact</button>
